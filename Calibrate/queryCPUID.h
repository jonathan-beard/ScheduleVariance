#ifndef _CPUIDQUERY_H_ 
#define _CPUIDQUERY_H_ 1
...
//get EFlags, return value is EFlags struct
EFlags getEFlags();

//sets EFlags to values contained in struct EFlags flags
void setEFlags(const EFlags flags);

//returns 1 if true, 0 otherwise
uint8_t is_cpu_id_supported();

//sets cpuid in output registers based on input from input_registers
